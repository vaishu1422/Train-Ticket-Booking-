...
<head>
    ...
    <link rel="stylesheet" href="fareenquiry.css">
...
<script>
    function getFare() {
        ...
        window.location.href = `fareresult.html?Source=${Source}&Destination=${Destination}`;
    }
</script>
</head>
<body>
...
<div class="container">
    <form class="form-group">
        ...
        <div class="flexbox">
                <div class="inputBox">
                    <span>Source</span>
                    <input type="text" id="source" class="card-holder-input" required>
                </div>
                <div class="inputBox">
                    <span>Destination</span>
                    <input type="text" id="destination" class="card-holder-input" required>
                </div>
            </div>
            <button type="button" class="submit-btn" onclick="getFare()">Get Fare</button>
