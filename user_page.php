...
if (!isset($_SESSION['admin_name']) || !isset($_SESSION['admin_email']) || !isset($_SESSION['admin_type'])) {
...
.profile-dropdown {
  ...
  <body>
    ...
    <div class="profile-dropdown-content">
        ...
        <a href="#">
            Email: <?php echo $_SESSION['admin_email']; ?> <!-- Display admin email -->
        </a>
        <a href="#">
            User Type: <?php echo $_SESSION['admin_type']; ?> <!-- Display admin user type -->
        </a>
        <a href="#">
            Booking History 
